...
import { For, type Component, createEffect, createSignal } from 'solid-js'
...
const  [secrets, setSecrets] = createSignal({})
  // Signals
    ...
    try {
      const data = await invoke('get_secret', { mount: kv, path });
      console.log(data);
      setSecrets(data);
    } catch (e) {
      console.error(e);
  ...
  return (
    <div class="p-5">
      <p class="font-bold">{contextValue().kv}{contextValue().path}</p>
